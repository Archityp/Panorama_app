...
GOOGLE_SHEETS_CREDENTIALS = secrets_data["GOOGLE_SHEETS_CREDENTIALS"]
SHEET_ID = secrets_data["SHEET_ID"]
SCOPE = secrets_data["SCOPE"]
MASTER_KEY = secrets_data["MASTER_KEY"]
# Google Sheets setup
